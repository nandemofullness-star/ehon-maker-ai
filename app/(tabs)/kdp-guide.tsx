...
const PHASES: Phase[] = [
  ...
  },
  {
    ...
    label: "校正刷り",
    emoji: "📦",
    description: "出版前に実物の見本を購入して印刷品質を確認できます。任意ですが強くおすすめします。",
    steps: [
      {
        id: "pr_what",
        title: "校正刷りとは何か",
        ...
        substeps: [
          {
            text: "校正刷りとは、Amazonで正式に販売される前に、自分だけが購入できる『見本刷り』のことです。実際に印刷・製本された本を手にとって、誤字・レイアウトのズレ・画像の色味などを確認できます。",
            note: "📌 重要な注意点：校正刷りの表紙・裏表紙は簡素なデザインになります。通常の販売版とは異なり、表紙のデザインが正確に反映されない場合があります。あくまで内容（本文・ページレイアウト）の確認用とお考えください。",
          },
          {
            text: "校正刷りには『Not for Resale（校正刷り：再販禁止）』という透かしが各ページに入り、一意のバーコードが印刷されます。ISBNは印刷されません。",
            note: "⚠️ 校正刷りは再販・転売禁止です。あくまで自分の確認用としてご利用ください。",
          },
        ],
      },
      {
        ...
        substeps: [
          {
            text: "価格設定ページの下部に「サンプル版を依頼」というセクションがあります。「校正刷りを依頼」ボタンをタップします。",
            highlight: "📍 価格設定ページ下部 →「サンプル版を依頼」→「校正刷りを依頼」ボタン",
          },
          {
            text: "確認ダイアログが表示されます。内容を読んで「校正刷りの依頼を確認」ボタンをタップします。",
            highlight: "📍 ダイアログ右下「校正刷りの依頼を確認」（黄色ボタン）",
            note: "注文の送信後4時間以内に、校正刷りの準備が行われ、注文を完了するためのリンクが電子メールで送信されます。",
          },
        ],
      },
      {
        id: "pr_order",
        title: "注文フォームで購入手続きをする",
        required: false,
        substeps: [
          {
            text: "校正刷りの注文フォームで以下を設定します：",
            highlight: "📍 注文フォームの入力項目",
            example: "注文数：1〜5部まで注文可能（通常は1部でOK）\nマーケットプレイス：注文するAmazonの国を選択（日本の場合はAmazon.co.jp）",
          },
          {
            text: "マーケットプレイスを選択すると「合計コスト（配送料と税金を除く）」が表示されます。印刷コストのみが請求され、通常の販売価格より安く購入できます。",
            note: "配送料や消費税は決済時に適用されます。",
          },
          {
            text: "「校正刷りの依頼を送信」ボタンをタップすると、4時間以内にメールが届きます。",
            highlight: "📍 画面右下「校正刷りの依頼を送信」（黄色ボタン）",
          },
        ],
      },
      {
        id: "pr_email",
        title: "メールのリンクから購入を完了する",
        required: false,
        substeps: [
          {
            text: "Amazonからメールが届いたら、24時間以内にメール内のリンクをタップして購入を完了します。",
            note: "⚠️ 24時間以内に購入を完了しないと、注文はキャンセルされます。メールが届いたらすぐに対応しましょう。",
          },
          {
            text: "購入完了後、通常のAmazon注文と同様に自宅に配送されます。届いたら本文・ページ順・画像の印刷品質を丁寧に確認してください。",
            note: "問題がなければ、そのまま出版申請（価格設定ページの「ペーパーバックを出版」）に進みましょう。修正が必要な場合は、PDFを修正して再アップロードしてから再度校正刷りを依頼できます。",
          },
        ],
      },
    ],
